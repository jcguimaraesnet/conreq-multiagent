...
Com base no impacto positivo de negócio e nos pares de perguntas e respostas contextuais fornecidos abaixo, sintetize uma declaração clara e concisa do comportamento funcional desejado no sistema. A declaração deve descrever O QUE o sistema deve fazer (não como), de forma verificável e sem ambiguidade.
